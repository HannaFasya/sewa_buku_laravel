...
class DataPeminjamController extends Controller
{
    ...
    public function collection_wherein(){
        $collection = DataPeminjam::all()->whereIn('kode_peminjam', ['P0003', 'P0004']);
        return $collection;
    ...
    public function collection_tojson(){
        $data = [
            ['kode_peminjam' => 'P0001', 'nama_peminjam' => 'Kamila'],
            ['kode_peminjam' => 'P0002', 'nama_peminjam' => 'Abdullah'],
            ['kode_peminjam' => 'P0003', 'nama_peminjam' => 'Mutia'],
            ['kode_peminjam' => 'P0004', 'nama_peminjam' => 'Jean'],
